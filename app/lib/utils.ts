...
export const getInputStyleClasses = (isError?: string | null) => {
  const className =
    'appearance-none block w-full rounded-xl border-0 py-2 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-black focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6';
