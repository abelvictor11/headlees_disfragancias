...
const Heading: React.FC<HeadingProps> = ({
  ...
  isCenter = false,
  hasNextPrev = false,
  fontClass = 'font-headline text-3xl md:text-4xl font-normal',
  rightDescText,
  ...
  return (
    <div
      className={clsx(
        'nc-Section-Heading relative flex flex-col sm:flex-row sm:items-end justify-between',
        className,
      )}
    >
      <div
      ...
      >
        <HeadingTag
          className={clsx(isCenter ? 'justify-center' : '', fontClass)}
          {...args}
        >
